...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno) {
        ...
        education.setBounds(300, 283, 400, 30);
        ...
        aadhar.setBounds(300, 445, 400, 30);
        add(aadhar);
        ...
        syes.setBounds(300, 495, 100, 30);
        syes.setBackground(Color.WHITE);
        add(syes);

        sno = new JRadioButton("No");
        sno.setBounds(450, 495, 100, 30);
        ...
        eyes.setBounds(300, 545, 100, 30);
        eyes.setBackground(Color.WHITE);
        add(eyes);

        eno = new JRadioButton("No");
        eno.setBounds(450, 545, 100, 30);
