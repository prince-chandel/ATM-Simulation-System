...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        JLabel personDetails = new JLabel("Page 1: Personal Deatails");
        ...
        fname.setBounds(100, 165, 200, 30);
        add(fname);

        fnameTextField = new JTextField();
        fnameTextField.setFont(new Font("Raleway", Font.BOLD, 14));
        fnameTextField.setBounds(300, 165, 400, 30);
        add(fnameTextField);

        JLabel dob = new JLabel("Date of Birth:");
        dob.setFont(new Font("Raleway", Font.BOLD, 20));
        dob.setBounds(100, 215, 200, 30);
        add(dob);

        dateChooser = new JDateChooser();
        dateChooser.setBounds(300, 215, 400, 30);
        ...
        other.setBounds(630, 365, 100, 30);
        ...
        cityTextField.setBounds(300, 465, 400, 30);
        add(cityTextField);
        ...
        stateTextField.setBounds(300, 515, 400, 30);
        add(stateTextField);
        ...
        pinTextField.setBounds(300, 565, 400, 30);
        add(pinTextField);
